...
export default function Contact() {
  ...
  function handleSubmit(e) {
    ...
    if (Object.keys(nextErrors).length === 0) {
      window.location.href = `mailto:i.petrovicova@gmail.com?subject=Portfolio contact from ${encodeURIComponent(
        formState.name,
  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit} noValidate className="max-w-lg space-y-5">
        ...
        <button
          type="submit"
          className="rounded-full bg-primary px-6 py-2.5 font-bold text-white shadow-sm transition-colors hover:bg-primary-dark"
        >
          Send Message
        </button>
        ...
        <AnimatePresence>
          {submitted && (
            ...
            >
              Thanks for reaching out! Your email client should now be open.
            </motion.p>
          )}
        </AnimatePresence>
      </form>
